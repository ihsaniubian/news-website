export const dynamic = 'force-dynamic'; // <--- Yeh line Politics page par bhi live data fetch karegi
...
export default async function PoliticsPage() {
  const newsList = await getNewsByCategory("Politics");
  ...
  return (
    <div className="min-h-screen">
      ...
      <main className="max-w-6xl mx-auto px-6 py-10">
        ...
        <p className="mb-8 text-gray-400">Latest politics updates and news</p>
